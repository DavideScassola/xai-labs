...
for dirpath, dirnames, filenames in os.walk(root_dir):
    ...
    for filename in filenames:
        ...
        if filename.endswith('.ipynb'):
            ...
            colab_link = f'<a href="https://colab.research.google.com/github/DavideScassola/xai-labs/blob/main/{dirpath}/{filename}" target="_parent"><img src="https://colab.research.google.com/assets/colab-badge.svg" alt="Open In Colab"/></a>'
